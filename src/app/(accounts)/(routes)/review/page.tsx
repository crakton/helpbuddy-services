        ...
        {isSuccess ? (
          data.data.map((review) => {
            return (
              <div
                key={review._id}
                className="py-6 px-4 flex flex-col lg:flex-row justify-between w-full bg-white drop-shadow rounded-lg"
              >
                      ...
                      <div className="flex flex-col gap-6">
                        ...
                        <div className="flex justify-start items-center gap-2">
                          <div className="w-[2.3rem] h-[2.3rem] overflow-hidden rounded-full relative flex justify-center items-center">
                            <Image
                              src={verifyImageUrl(
                                review?.userId.avatar as string
                              )}
                              alt="review"
                              priority
                              fill
                          ...
                          <span className="sm:text-sm text-[0.65rem] text-afruna-gray"></span>
                        </div>
                      </div>
                    </div>
